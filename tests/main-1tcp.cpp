...
int main() {
    ...
    TcpSinkLoggerSampling sinkLogger(timeFromMs(20), eventlist);
    QueueLoggerSampling queueLogger(timeFromMs(20), eventlist);
    ...
    // outgoing
#define RTT1 timeFromMs(40)
#define RTT2 timeFromMs(40)
...
#define FEEDER_BUFFER memFromPkt(100000)
#define SW_BUFFER memFromPkt(100000)
#define INGRESS_LINKSPEED speedFromMbps((uint64_t)1000)
#define CORE_LINKSPEED speedFromMbps((uint64_t)1000)
    ...
    tcp_src->_ssthresh = timeAsSec(RTT1+RTT2) * speedFromMbps((uint64_t)500);
